    ...
    class Program
    {
        ...
        static void CreateNewCom()
        {
            ...
            if (catalogObject1Cv8 == null)
            {
                ...
                new1Cv8App.Value["Activation"] = COMAdminActivationOptions.COMAdminActivationLocal;
                new1Cv8App.Value["Authentication"] = COMAdminAuthenticationLevelOptions.COMAdminAuthenticationPacket;
                new1Cv8App.Value["ApplicationAccessChecksEnabled"] = 0;
                new1Cv8App.Value["AccessChecksLevel"] = 1;
                new1Cv8App.Value["ImpersonationLevel"] = 3;
                new1Cv8App.Value["SRPEnabled"] = 1;
                new1Cv8App.Value["SRPTrustLevel"] = 0x40000;
